...
/// Represents an opaque handle type <a href="https://registry.khronos.org/OpenCL/sdk/latest/docs/man/html/cl_context.html">cl_context</a>.
///
/// ## Contracts
///
...
///
/// @see <a href="https://registry.khronos.org/OpenCL/sdk/latest/docs/man/html/cl_context.html">cl_context</a>
@ValueBasedCandidate
@UnsafeConstructor
public record CLContext(@NotNull MemorySegment segment) implements IPointer {
    /// Represents a pointer to <a href="https://registry.khronos.org/OpenCL/sdk/latest/docs/man/html/cl_context.html">cl_context</a> handle(s) in native memory.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IPointer, Iterable<CLContext> {
        public long size() {
        ...
        @Override
        public @NotNull Iterator<CLContext> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the handles.
        private static class Iter implements Iterator<CLContext> {
