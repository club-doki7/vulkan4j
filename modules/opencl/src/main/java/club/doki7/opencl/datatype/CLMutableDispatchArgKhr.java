...
/// Represents a pointer to a <a href="https://registry.khronos.org/OpenCL/sdk/latest/docs/man/html/cl_mutable_dispatch_arg_khr.html">cl_mutable_dispatch_arg_khr</a> structure in native memory.
///
/// ## Structure
///
/// {@snippet lang=c :
...
///
/// @see <a href="https://registry.khronos.org/OpenCL/sdk/latest/docs/man/html/cl_mutable_dispatch_arg_khr.html">cl_mutable_dispatch_arg_khr</a>
@ValueBasedCandidate
@UnsafeConstructor
public record CLMutableDispatchArgKhr(@NotNull MemorySegment segment) implements ICLMutableDispatchArgKhr {
    /// Represents a pointer to / an array of <a href="https://registry.khronos.org/OpenCL/sdk/latest/docs/man/html/cl_mutable_dispatch_arg_khr.html">cl_mutable_dispatch_arg_khr</a> structure(s) in native memory.
    ///
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements ICLMutableDispatchArgKhr, Iterable<CLMutableDispatchArgKhr> {
        public long size() {
        ...
        @Override
        public @NotNull Iterator<CLMutableDispatchArgKhr> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the structures.
        private static final class Iter implements Iterator<CLMutableDispatchArgKhr> {
