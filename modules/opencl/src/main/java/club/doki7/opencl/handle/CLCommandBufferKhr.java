...
/// Represents an opaque handle type <a href="https://registry.khronos.org/OpenCL/sdk/latest/docs/man/html/cl_command_buffer_khr.html">cl_command_buffer_khr</a>.
///
/// ## Contracts
///
...
///
/// @see <a href="https://registry.khronos.org/OpenCL/sdk/latest/docs/man/html/cl_command_buffer_khr.html">cl_command_buffer_khr</a>
@ValueBasedCandidate
@UnsafeConstructor
public record CLCommandBufferKhr(@NotNull MemorySegment segment) implements IPointer {
    /// Represents a pointer to <a href="https://registry.khronos.org/OpenCL/sdk/latest/docs/man/html/cl_command_buffer_khr.html">cl_command_buffer_khr</a> handle(s) in native memory.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IPointer, Iterable<CLCommandBufferKhr> {
        public long size() {
        ...
        @Override
        public @NotNull Iterator<CLCommandBufferKhr> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the handles.
        private static class Iter implements Iterator<CLCommandBufferKhr> {
