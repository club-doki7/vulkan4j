...
/// Represents an opaque handle type <a href="https://registry.khronos.org/OpenCL/sdk/latest/docs/man/html/cl_accelerator_intel.html">cl_accelerator_intel</a>.
///
/// ## Contracts
///
...
///
/// @see <a href="https://registry.khronos.org/OpenCL/sdk/latest/docs/man/html/cl_accelerator_intel.html">cl_accelerator_intel</a>
@ValueBasedCandidate
@UnsafeConstructor
public record CLAcceleratorIntel(@NotNull MemorySegment segment) implements IPointer {
    /// Represents a pointer to <a href="https://registry.khronos.org/OpenCL/sdk/latest/docs/man/html/cl_accelerator_intel.html">cl_accelerator_intel</a> handle(s) in native memory.
    ///
    /// ## Contracts
    ///
    /// The property {@link #segment()} should always be not-null
    ...
    @ValueBasedCandidate
    @UnsafeConstructor
    public record Ptr(@NotNull MemorySegment segment) implements IPointer, Iterable<CLAcceleratorIntel> {
        public long size() {
        ...
        @Override
        public @NotNull Iterator<CLAcceleratorIntel> iterator() {
            return new Iter(this.segment());
        }

        /// An iterator over the handles.
        private static class Iter implements Iterator<CLAcceleratorIntel> {
